...
describe("stable production rollback contract", () => {
  ...
  it("keeps the in-app update prompt wired to the live service worker version", () => {
    ...
    expect(html).toContain("const APP_CACHE_VERSION = 'blue-wallet-stable-rollback-v0.22'");
    ...
    expect(worker).toContain('const CACHE_VERSION = "blue-wallet-stable-rollback-v0.22"');
  });
